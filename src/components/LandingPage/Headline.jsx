...
export default function Headline() {
  return (
    <section id="Headline" className="lg:px-20 px-4 py-24">
      <div className="h-screen md:h-auto flex md:flex-row md:justify-between gap-12 flex-col items-center md:items-start">
        <div className="order-2 md:order-1">
          <h1 className="text-primary-900 text-4xl lg:text-5xl xl:text-6xl font-bold">Hi, I'm Cut Risfa Zuhra 👋</h1>
          <p className="text-primary-600 text-base font-normal mt-2 xl:w-192 w-85 sm:w-142 md:w-125">
